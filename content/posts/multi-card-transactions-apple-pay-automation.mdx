---
title: Expenses tracking automation
description: How do I track my expenses using Apple Pay and Telegram bot?
date: "2024-05-07"
readingTime: 10
---
...
So as user message I am sending transaction data:
```
{
    "amount": 12.34,
    "vendor": "McDonald's",
...
All API calls needed here I am handling in another Make.com scenario. I am planning to rewrite it to my own backend in the future (number of active scenarios in Make.com is limited, at least in plan I am using).
...
I am quite happy with automation I have built. I have access to all my transactions data which opens up many possibilities.
In the future I am planning to rewrite Make.com scenarios to my own backend.
